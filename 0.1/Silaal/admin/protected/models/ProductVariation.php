...
/**
 * This is the model class for table "yc_product_variation".
 *
 * The followings are the available columns in table 'yc_product_variation':
 * @property integer $id
		...
		foreach($variations as $id => $variation) 
			if($variation->price_adjustion == 0) 
				...
				$var[$variation->id] = sprintf('%s (%s%s)',
						...
						Yep::priceFormat($variation->price_adjustion));
