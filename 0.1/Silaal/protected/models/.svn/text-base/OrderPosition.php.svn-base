 ...
 *
 * The followings are the available columns in table 'yc_order_position':
 * @property integer $id
...
class OrderPosition extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'order_id' => Yep::t('Order'),
			'product_id' => Yep::t('Product'),
			'amount' => Yep::t('Amount'),
			'specifications' => Yep::t('Specifications'),
		);
	}
