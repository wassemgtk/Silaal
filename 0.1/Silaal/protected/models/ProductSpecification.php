...
/**
 * This is the model class for table "yc_product_specification".
 *
 * The followings are the available columns in table 'yc_product_specification':
 * @property integer $id
...
class ProductSpecification extends CActiveRecord
{
	...
	{
		return 'yc_product_specification';
	}
