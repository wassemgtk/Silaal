...
<?php foreach($model->products as $position) { ?>
        <tr> 
		  ...
		  <td style="border-right: 2px solid; border-bottom: 2px solid; border-color: #ffffff;"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo Yep::priceFormat($position->getPrice()); ?></font></td>
        </tr>
        <?php } ?>
<?php if($model->shippingMethod) { ?>
        <tr> 
		  ...
		  <td style="border-right: 2px solid; border-bottom: 2px solid; border-color: #ffffff;"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo Yep::priceFormat($model->shippingMethod->price); ?></font></td>
        </tr>
<?php } ?> 
    ...
    <td nowrap> <table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr> 
          <td nowrap width="100%" style="border-right: 2px solid; border-bottom: 2px solid; border-color: #ffffff;"><div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo Yep::t('Total value'); ?>
              <?php echo Yep::priceFormat($model->getTotalPrice()); ?></font></div></td>
        </tr>
        </table></td>
  </tr>
</table>
