<div class="span-5 last">
      <ul id="right_sidebar">
        <li class="my_cart sidebar_content">
          <h3><?php echo CHtml::link(Yep::t('View Shopping Cart'), array(
				'/shoppingcart/view'));?></h3>
          <div class="padding10">
          <?php $cart = Yep::getCartContent(); if(!empty($cart))$this->widget('ShoppingCartWidget');else{ ?>
          <p><?php Yep::t('You have no items in your shopping cart.');?></p>
          <?php }?>
          </div>
        </li>
...
<a href="#" class="btn_ornge"><span>vote</span></a></form>
        ...
        <li class="sidebar_content advertise prepend-top"><img src="<?php echo Yii::app()->request->baseUrl;?>/images/wako.jpg" /></li>
      </ul>
