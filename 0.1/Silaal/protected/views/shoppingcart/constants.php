...
$res=PaypalConfig::model()->findByAttributes(array('NAME'=>'API_USERNAME'));
if(!defined('API_USERNAME'))
define('API_USERNAME', trim($res->VALUE));
//
...
*/
$res=PaypalConfig::model()->findByAttributes(array('NAME'=>'API_PASSWORD'));
if(!defined('API_PASSWORD'))
define('API_PASSWORD', trim($res->VALUE));

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/
$res=PaypalConfig::model()->findByAttributes(array('NAME'=>'API_SIGNATURE'));
if(!defined('API_SIGNATURE'))
define('API_SIGNATURE', trim($res->VALUE));
...
if(!defined('ACK_SUCCESS'))
define('ACK_SUCCESS', 'SUCCESS');
if(!defined('ACK_SUCCESS_WITH_WARNING'))
