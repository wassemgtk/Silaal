...
if(!isset($token)) {
	...
	*/
	...
	for($position=0;$position<$siteConfig->value;$position++){
		if(isset($_REQUEST["L_NAME".$position]) and isset($_REQUEST["L_AMT".$position]) and isset($_REQUEST["L_QTY".$position])){
			${"L_NAME".$position}= $_REQUEST["L_NAME".$position];
			${"L_AMT".$position} = $_REQUEST["L_AMT".$position];
			${"L_QTY".$position} = $_REQUEST["L_QTY".$position];
