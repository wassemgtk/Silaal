      ...
      <div class="span-19 last">
        <div class="content product_page">
          ...
          <div class="span-10 product_info last">
            <h3 class="product_name"><?php echo $model->title; ?></h3>
           <!--  <div class="span-2"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/rating.jpg" /></div> -->
<!--             <div class="span-8 reviews last"><a href="#">1 Review(s)</a>|<a href="#">Add Your Review</a></div> -->
            <!--end of reviews-->
            <div class="availability">
              <label for="availability">Availability</label>
              : <span class="availability_status">In Stock</span></div><br>
            <!--end of availability-->
            <!-- <div class="size">
